...
public class App_a {
  ...
  public static void main(String[] args) {
    ...
    //1번 회원 입력
    System.out.print("번호? ");
    no1 = keyInput.nextInt(); // nextInt()는 입력 값 중에서 숫자만 뽑아간다.
    ...
    //2번 회원 입력
    System.out.print("번호? ");
    no2 = keyInput.nextInt(); // nextInt()는 입력 값 중에서 숫자만 뽑아간다.
    keyInput.nextLine(); // 숫자 뒤에 남아 있는 CR/LF 값 읽어서 버리기 
    ...
    //3번 회원 입력
    System.out.print("번호? ");
    no3 = keyInput.nextInt(); // nextInt()는 입력 값 중에서 숫자만 뽑아간다.
    keyInput.nextLine(); // 숫자 뒤에 남아 있는 CR/LF 값 읽어서 버리기 
    ...
    //4번 회원 입력
    System.out.print("번호? ");
    no4 = keyInput.nextInt(); // nextInt()는 입력 값 중에서 숫자만 뽑아간다.
    keyInput.nextLine(); // 숫자 뒤에 남아 있는 CR/LF 값 읽어서 버리기 
    ...
    //5번 회원 입력
    System.out.print("번호? ");
    no5 = keyInput.nextInt(); // nextInt()는 입력 값 중에서 숫자만 뽑아간다.
    keyInput.nextLine(); // 숫자 뒤에 남아 있는 CR/LF 값 읽어서 버리기 
