...
public class App_c {
  ...
  public static void main(String[] args) {
    ...
    //1번 회원 입력
    System.out.print("번호? ");
    no[0] = keyInput.nextInt(); // nextInt()는 입력 값 중에서 숫자만 뽑아간다.
    ...
    if(response.equalsIgnoreCase("y")) {
      ...
      //2번 회원 입력
      System.out.print("번호? ");
      no[1] = keyInput.nextInt(); // nextInt()는 입력 값 중에서 숫자만 뽑아간다.
      keyInput.nextLine(); // 숫자 뒤에 남아 있는 CR/LF 값 읽어서 버리기 
      ...
      if(response.equals("y") || response.equals("Y")) {
        ...
        //3번 회원 입력
        System.out.print("번호? ");
        no[2] = keyInput.nextInt(); // nextInt()는 입력 값 중에서 숫자만 뽑아간다.
        keyInput.nextLine(); // 숫자 뒤에 남아 있는 CR/LF 값 읽어서 버리기 
        ...
        if(response.equals("y") || response.equals("Y")) {
          ...
          //4번 회원 입력
          System.out.print("번호? ");
          no[3] = keyInput.nextInt(); // nextInt()는 입력 값 중에서 숫자만 뽑아간다.
          keyInput.nextLine(); // 숫자 뒤에 남아 있는 CR/LF 값 읽어서 버리기 
          ...
          if(response.equals("y") || response.equals("Y")) {
            ...
            //5번 회원 입력
            System.out.print("번호? ");
            no[4] = keyInput.nextInt(); // nextInt()는 입력 값 중에서 숫자만 뽑아간다.
            keyInput.nextLine(); // 숫자 뒤에 남아 있는 CR/LF 값 읽어서 버리기 
