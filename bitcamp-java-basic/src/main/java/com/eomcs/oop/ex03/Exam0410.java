...
public class Exam0410 {
  ...
  public static void main(String[] args) {
    // 인스턴스를 생성할 대 반드시 호출될 생성자를 지정해야 한다.
    // 안하면 문법 오류이다.
    ...
    // 다음과 같이 호출될 생성자를 지정하지 않으면 문법오류이다.
    //    SmartPhone obj1 = new SmartPhone;// 컴파일 오류!
    // 다음과 같이 존재하지 않는 생성자를 지정하면 문법오류이다!
    //    SmartPhone obj1 = new SmartPhone(100); // int파라미터를 가지는 생성자가 없


    // SmartPhone 인스턴스를 만들 떄 기본 생성자가 호출되게 한다.
