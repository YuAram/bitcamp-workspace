...
public class MyLinkedList10 {
  ...
  // static class?
  // - 여러 개의 LinkedList 객체가 공유하는 클래스이므
  //   static 으로 Node 클래스를 설계한다.
  static class Node {
    Object value;
    Node next;
